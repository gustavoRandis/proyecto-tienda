...
{
    // Este DTO encapsula la información necesaria para crear un producto en la base de datos
    public class CrearProductoDTO
    {
        ...
        public int Cant_producto { get; set; } // Cant_producto en la base de datos: 'Cant_producto'
        public int Identificador { get; set; } // Identificador en la base de datos: 'Identificador
